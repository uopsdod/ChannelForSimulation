...
public class ResponseAgentthirdpartyvoice_TransferRunnable implements Runnable{
	@Override
	public void run() {
		/**
		{
		...
		"text":"<ul><li><div><div class=\"layim-chat-user pull-left\"><img src=\"resources/layui/css/pc/layim/skin/new_logo.jpg\"></div><div class=\"layim-chat-text\">系統訊息: A 進入聊天視窗</div></div></li><li><div><div class=\"layim-chat-user pull-left\"><img src=\"resources/layui/css/pc/layim/skin/new_logo.jpg\"></div><div class=\"layim-chat-text\">系統訊息: B 離開聊天視窗</div></div></li></ul>",
		"response":"accept",
		"entitytypeid":"2",
		"channel":"2"
		}
		...
		inviteJson.addProperty("type", "responsethirdparty");
		inviteJson.addProperty("userID", TestUtil.dialNO_agent02);
		...
		inviteJson.addProperty("inviteType", "transfer");
		inviteJson.addProperty("entityTypeID", TestUtil.entityTypeID);
		inviteJson.addProperty("channel", TestUtil.entityTypeID);
		
		inviteJson.addProperty("response", "accept"); // "accept"
		inviteJson.addProperty("text", "");
