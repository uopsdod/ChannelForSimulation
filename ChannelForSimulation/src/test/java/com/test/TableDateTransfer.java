...
public class TableDateTransfer implements Runnable{
	@Override
	public void run() {
		/**
		 * 
...
//		AmqpUtil.getAmqpTemplate().convertAndSend(AmqpUtil.QUEUE_NAME.CHANNEL_TO_BACKEND_QUEUE01, json);
    	...
    	String beanName = "CallLog";
    	
		/** 建立資料 **/
		List<AbstractMap.SimpleEntry<String, String>> params = new ArrayList<>();
//		params.add(new AbstractMap.SimpleEntry<String, String>("interactionid", interactionid));
		/** 建立URL字串 **/
		String hostURL = Util.getHostURLStr("RESTful");
		String projectName = Util.getProjectStr("RESTful");
		String urlStr = hostURL + "/" + projectName + "/RESTful/getResource/" + beanName;
